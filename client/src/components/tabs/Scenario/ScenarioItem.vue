...
export default {
  ...
  emits: ['save-info', 'select', 'duplicate', 'delete'],
  data() {
    return {
      isEditing: false,
      tempLabel: '',
...
<style scoped>
/* Stili riga Scenario e Edit Mode estratti da TabArchivio */
.scenario-row { border: 1px solid #e2e8f0; padding: 15px; border-radius: 8px; background: #f8fafc; margin-bottom: 12px; list-style: none; }
...
.scenario-actions button { background: white; border: 1px solid #cbd5e1; border-radius: 4px; cursor: pointer; font-size: 16px; padding: 6px 10px; }
